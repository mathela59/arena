 ...
 */
final class Version20190925162838 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE sentences (id INT AUTO_INCREMENT NOT NULL, style_id INT NOT NULL, race_id INT NOT NULL, content LONGTEXT NOT NULL, action LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', critical TINYINT(1) NOT NULL, INDEX IDX_ED2A8F1EBACD6074 (style_id), INDEX IDX_ED2A8F1E6E59D40D (race_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
