 ...
 */
final class Version20190926134206 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE characteristic ADD minimum INT NOT NULL, ADD maximum INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE characteristic DROP minimum, DROP maximum');
