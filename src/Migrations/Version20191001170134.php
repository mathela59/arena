 ...
 */
final class Version20191001170134 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE warrior_characteristic (id INT AUTO_INCREMENT NOT NULL, warrior_id INT DEFAULT NULL, characteristic_id INT NOT NULL, value INT NOT NULL, INDEX IDX_78BFC005452AFEA4 (warrior_id), INDEX IDX_78BFC005DEE9D12B (characteristic_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE warrior (id INT AUTO_INCREMENT NOT NULL, fighting_style_id INT NOT NULL, race_id INT NOT NULL, user_id INT NOT NULL, name VARCHAR(255) NOT NULL, victories INT NOT NULL, defeats INT NOT NULL, life INT NOT NULL, experience INT NOT NULL, INDEX IDX_2E47A14B13949A02 (fighting_style_id), INDEX IDX_2E47A14B6E59D40D (race_id), INDEX IDX_2E47A14BA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
