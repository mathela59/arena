 ...
 */
final class Version20220503162357 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE warrior (id INT NOT NULL, coach_id INT NOT NULL, breed_id INT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, experience INT NOT NULL, strength INT NOT NULL, speed INT NOT NULL, dexterity INT NOT NULL, constitution INT NOT NULL, intelligence INT NOT NULL, will INT NOT NULL, PRIMARY KEY(id))');
